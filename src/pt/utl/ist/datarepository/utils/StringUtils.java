...
public class StringUtils {
	...
	public static String splitName(String nameWithoutSpaces) {
    	return nameWithoutSpaces.replaceAll("(\\p{Ll})(\\p{Lu})","$1 $2");
    }
	
	public static String joinName(String nameWithSpaces) {
		return nameWithSpaces.replaceAll(" ", "");
	}
}
